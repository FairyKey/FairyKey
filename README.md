...
- **Library:** Create, organize, and share sheets
	- Sheets are stored as `.txt` files with [optional metadata](sheetguide) such as the songs Title, Artist, and sheet creator.
	- Folder support
...
3. Follow the [Fairy Key Sheet Format Guide](sheetguide)
